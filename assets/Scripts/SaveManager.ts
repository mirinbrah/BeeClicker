...
export class SaveManager extends Component {
    ...
    public saveGame(): void {
        const saveData = {
            ...
            honeyPerClickBonus: GameData.honeyPerClickBonus,
    ...
    public loadGame(): void {
        ...
        if (savedDataString) {
            ...
            GameData.honeyPerClickBonus = savedData.honeyPerClickBonus || 0;
            GameData.goldPerSecond = savedData.goldPerSecond || 0;
        } else {
    ...
    private resetToDefaults(): void {
        ...
        GameData.honeyPerClickBonus = 0;
        GameData.goldPerSecond = 0;
    }
}